...
To further lock down the account, restrict access from certain
hosts and private ssh keys. See Linux Journal article I<Paranoid
Penguin - Managing SSH for Scripts and cron Jobs> at
