...
Due to lack of available tools in POSIX shell, combining short options
is not supported; .e.g. B<-fi>. All options must be give separately
using spaces like in B<-f> B<-i>.
